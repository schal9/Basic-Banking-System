...
<body>
	...
	<div class="container-fluid">
		<div class="s-heading" >
			<h2>A<font color="#2F4F4F">ll</font> Use<font color="#2F4F4F">rs </font> </h2>
		</div></div>
		<table class="table table-bordered"  style="text-align: center;font-family: Times New Roman; font-size: 18px">
  <thead>
